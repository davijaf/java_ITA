...
public class testeCarrinhoCalculaValor {
	...
	public void carrinho0() {
		...
		assertEquals(50,c0.getcalculaValor()); //Verificar preco somado
		}
	...
	public void carrinho1() {
		...
		assertEquals(86,c1.getcalculaValor()); //Verificar preco somado
		}
	...
	public void carrinho2() {
		...
		assertEquals(58,c2.getcalculaValor()); //Verificar preco somado
		}
